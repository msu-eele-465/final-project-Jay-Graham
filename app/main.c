...
int rotate_flag = 0;                        // flag to indicate switch presses
int left_flag = 0;                          // flag to indicate left joystick movement
int right_flag = 0;                         // flag to indicate right joystick movement
